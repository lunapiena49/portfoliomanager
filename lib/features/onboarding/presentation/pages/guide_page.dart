      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSection(
            ...
            titleKey: 'guide.sections.data_pipeline.title',
            contentKey: 'guide.sections.data_pipeline.content',
            detailsKey: 'guide.sections.data_pipeline.details',
          ),
          SizedBox(height: 16.h),
          _buildSection(
            context,
          ...
          _buildSection(
            ...
            titleKey: 'guide.sections.providers_catalog.title',
            contentKey: 'guide.sections.providers_catalog.content',
            detailsKey: 'guide.sections.providers_catalog.details',
          ),
          SizedBox(height: 16.h),
          _buildSection(
            context,
            icon: Icons.schedule,
            titleKey: 'guide.sections.refresh_interval.title',
            contentKey: 'guide.sections.refresh_interval.content',
            detailsKey: 'guide.sections.refresh_interval.details',
          ),
          SizedBox(height: 16.h),
          _buildSection(
            context,
            icon: Icons.warning_amber,
            titleKey: 'guide.sections.quota_alerts.title',
            contentKey: 'guide.sections.quota_alerts.content',
            detailsKey: 'guide.sections.quota_alerts.details',
          ),
          SizedBox(height: 16.h),
          _buildSection(
            context,
          ...
          _buildSection(
            ...
            titleKey: 'guide.sections.troubleshooting.title',
            contentKey: 'guide.sections.troubleshooting.content',
            detailsKey: 'guide.sections.troubleshooting.details',
          ),
          SizedBox(height: 16.h),
          _buildSection(
            context,
