      ...
      builder: (context, constraints) {
        return SingleChildScrollView(
          ...
          child: ConstrainedBox(
            ...
            // SizedBox(width: double.infinity) forces the Column to take the
            // full cross-axis width of the SingleChildScrollView so that
            // crossAxisAlignment.center centers children against the screen,
            // not against the Column's intrinsic (button-sized) width.
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  OutlinedButton.icon(
                    onPressed: () => context
                        .push('${RouteNames.home}/create-portfolio'),
